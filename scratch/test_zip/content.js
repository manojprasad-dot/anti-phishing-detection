...
const EMAIL_APP_HOSTS = new Set([
  "mail.google.com",
  "outlook.live.com",
  "outlook.office.com",
  "outlook.office365.com"
]);
const IS_EMAIL_APP = EMAIL_APP_HOSTS.has(window.location.hostname);
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (IS_EMAIL_APP && shouldSuppressBadgeMessage(message?.type)) {
    return;
  }
...
function shouldSuppressBadgeMessage(type) {
